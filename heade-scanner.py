...
def report(all_url,duration_process=None,failure_count=None):
  ...
  table = [["Duration", duration_process, "Duration of process"],["","" , ""],["All URLs", all_url, "Number of URL in input file"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--file", dest="urls_file", required=False, help="Path to a text file containing URLs, each url in a line (required)")
    ...
    parser.add_argument("-i","--ignore-ssl-errors", action="store_false", default=True, help="Ignore SSL verification errors ")
